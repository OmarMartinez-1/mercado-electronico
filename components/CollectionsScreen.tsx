...
import CardsAndSamplesKit from "./CardsAndSamplesKit"
...
function CollectionsScreen({ dataScreens }: any) {
    ...
    const accessoriesFiltered = Products.filter((item)=> { if(accessories.includes(item.id)){return item}})
    ...
    return (
        <>
            ...
            <View style={styles.wrapperWide}>
                ...
                {onPath && <CardsAndSamplesKit productsIds={productsIds} />}
